...
Using a Branch: They then work on their features or fixes within these branches [4]. The term "using" refers to applying, employing, or utilizing the branch for development.
